...
function jogar() {
    if (document.getElementById("pedra").checked == false && document.getElementById("papel").checked == false && document.getElementById("tesoura").checked == false) {
        ...
        switch (sorteio) {
            case 0:
                document.getElementById("robo").src = "pedra robo .png";
                break;
            case 1:
                document.getElementById("robo").src = "papelrobo.png";
                break;
            case 2:
                document.getElementById("robo").src = "tesoura robo.png";
                break;
        }
...
function resetar() {
    document.getElementById("robo").src = "robo .png";
